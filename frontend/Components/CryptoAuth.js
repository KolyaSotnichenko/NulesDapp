    ...
    <Provider>
      <View style={styles.mainBody}>
        <ScrollView
          ...
          <Image
            style={{ flex: 1, width: '100%', marginTop: 40, alignSelf: 'center',}}
            ...
            <KeyboardAvoidingView enabled>
              ...
              <View style={{alignItems: 'center', justifyContent: 'center'}}>
                ...
                >
                  <TouchableOpacity
                    activeOpacity={0.5}
                    onPress={() => Linking.openURL('https://github.com/KolyaSotnichenko') }
                  >
                    <Icon name="github" size={35} color="black"/>
                  </TouchableOpacity>
                  <TouchableOpacity
                    activeOpacity={0.5}
                    onPress={() => Linking.openURL('https://t.me/kolya_sotnichenko') }
                  >
                    <Icon name="telegram" size={35} color="gray"/>
                  </TouchableOpacity>
                  <TouchableOpacity
                    activeOpacity={0.5}
                    onPress={() => Linking.openURL('mailto:kolya.sotnichenko0811@gmail.com') }
                  >
